    ...
    public function up(): void
    {
        ...
        $additions = [
            [
                ...
                'id' => AdditionId::ReconciliationTaxable->value,
                'name' => 'Reconciliation (Taxable)',
                'description' => 'Reconciliations/adjustments (taxable)',
                'required' => false,
                'calculated' => false,
                'taxable' => true,
                'hour_based' => false,
                ...
                'id' => AdditionId::ReconciliationNonTaxable->value,
                'name' => 'Reconciliation (Non-taxable)',
                'description' => 'Reconciliations/adjustments (non-taxable)',
                'required' => false,
                'calculated' => false,
                'taxable' => false,
                'hour_based' => false,
        ...
        $deductions = [
            [
                ...
                'id' => DeductionId::ReconciliationTaxable->value,
                'name' => 'Reconciliation (Taxable)',
                'description' => 'Reconciliations/adjustments (taxable)',
                'required' => false,
                'calculated' => false,
                ...
                'id' => DeductionId::ReconciliationNonTaxable->value,
                'name' => 'Reconciliation (Non-taxable)',
                'description' => 'Reconciliations/adjustments (non-taxable)',
                'required' => false,
                'calculated' => false,
