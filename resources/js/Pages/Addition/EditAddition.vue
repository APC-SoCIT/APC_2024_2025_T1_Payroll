...
<template>
    <Head title="Editing Addition Type" />

    <AuthenticatedLayout>
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Editing Addition Type
            </h2>
        </template>
        ...
        <div class="py-12">
            <div class="max-w-5xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                    <h2 class="font-semibold text-xl text-gray-800 leading-tight">Editing Addition Type {{ addition.name }}</h2>
                    <form @submit.prevent="form.patch(route('addition.update', addition.id))">
                        <div class="py-3">
