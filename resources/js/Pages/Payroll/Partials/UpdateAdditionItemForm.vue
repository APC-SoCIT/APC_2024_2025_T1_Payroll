...
<template>
    <section>
        ...
        <form @submit.prevent="form.patch(route('payroll.updateAdditionItem', additionItem.id))" class="mt-6 space-y-6">
            <div>
            ...
            <Link
                v-if="!periodHasEnded"
                :href="route('payroll.deleteAdditionItem', additionItem.id)"
                method="delete"
